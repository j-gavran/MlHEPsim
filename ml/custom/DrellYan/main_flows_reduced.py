...
@timeit(unit="min")
@hydra.main(config_path="config/flows/", config_name="main_config_reduced", version_base=None)
def main(config):
    setup_logger()
    ...
    # data processing 
    npy_proc = DrellYanNpyProcessor(data_dir="ml/data/drellyan/", base_file_name="DRELLYAN", list_data_features = data_conf["feature_selection"]["keep_names"]) 
